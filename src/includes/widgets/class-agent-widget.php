...
<p class="description option-end"><?php _e( 'Use "auto" for a gender-related default title.', 'immonex-kickstart-team' ); ?></p>
...
<p class="description option-end"><?php _e( 'Add links to agent photo/name and the company name.', 'immonex-kickstart-team' ); ?></p>
