---
title: Agentur-Listenansicht rendern (Action)
search: 1
---

# inx_team_render_agency_list (Action)

Über diesen Action-Hook kann eine [Agentur-Listenansicht](../komponenten/index.html) in eine Template-Datei eingebunden werden.
...
| | `template` (string): zu rendernde Template-Datei im [Skin-Ordner](../anpassung-erweiterung/skins.html#Ordner), Standard: *agency-list/index* |
